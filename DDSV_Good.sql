...
INSERT INTO LopMonHoc(MaLopMonHoc, SiSo, MaMonHoc, MaGiangVien, NgayBD, NgayKT) 
VALUES
('LMH009', 40, 'MH01', 'GV001', '2023-01-10', '2023-05-10'),
('LMH010', 35, 'MH02', 'GV001', '2023-01-15', '2023-05-15'),
('LMH011', 30, 'MH03', 'GV001', '2023-01-20', '2023-05-20')
--SV_LMH09
INSERT INTO SV_LopMonHoc (MaLopMonHoc, MaSinhVien, HocKy, NamHoc)
VALUES
('LMH009', 'SV001', '2023A', '2023-2024'),
('LMH009', 'SV002', '2023A', '2023-2024'),
('LMH009', 'SV003', '2023A', '2023-2024'),
('LMH009', 'SV004', '2023A', '2023-2024'),
('LMH009', 'SV005', '2023A', '2023-2024');
--DD LMH09
INSERT INTO DiemDanh (MaSinhVien, MaLopMonHoc, NgayHoc, TrangThai)
SELECT MaSinhVien, MaLopMonHoc, '2023-02-15', NULL FROM SV_LopMonHoc WHERE MaLopMonHoc = 'LMH009'
UNION ALL
SELECT MaSinhVien, MaLopMonHoc, '2023-02-20', NULL FROM SV_LopMonHoc WHERE MaLopMonHoc = 'LMH009'
UNION ALL
SELECT MaSinhVien, MaLopMonHoc, '2023-02-25', NULL FROM SV_LopMonHoc WHERE MaLopMonHoc = 'LMH009'
UNION ALL
SELECT MaSinhVien, MaLopMonHoc, '2023-03-01', NULL FROM SV_LopMonHoc WHERE MaLopMonHoc = 'LMH009'
UNION ALL
SELECT MaSinhVien, MaLopMonHoc, '2023-03-05', NULL FROM SV_LopMonHoc WHERE MaLopMonHoc = 'LMH009'
UNION ALL
SELECT MaSinhVien, MaLopMonHoc, '2023-03-10', NULL FROM SV_LopMonHoc WHERE MaLopMonHoc = 'LMH009';
--SV LMH010
INSERT INTO SV_LopMonHoc (MaLopMonHoc, MaSinhVien, HocKy, NamHoc)
VALUES
('LMH010', 'SV001', '2023A', '2023-2024'),
('LMH010', 'SV002', '2023A', '2023-2024'),
('LMH010', 'SV003', '2023A', '2023-2024'),
('LMH010', 'SV004', '2023A', '2023-2024'),
('LMH010', 'SV005', '2023A', '2023-2024');

--DD LMH010
INSERT INTO DiemDanh (MaSinhVien, MaLopMonHoc, NgayHoc, TrangThai)
SELECT MaSinhVien, MaLopMonHoc, '2023-02-15', NULL FROM SV_LopMonHoc WHERE MaLopMonHoc = 'LMH010'
UNION ALL
SELECT MaSinhVien, MaLopMonHoc, '2023-02-20', NULL FROM SV_LopMonHoc WHERE MaLopMonHoc = 'LMH010'
UNION ALL
SELECT MaSinhVien, MaLopMonHoc, '2023-02-25', NULL FROM SV_LopMonHoc WHERE MaLopMonHoc = 'LMH010'
UNION ALL
SELECT MaSinhVien, MaLopMonHoc, '2023-03-01', NULL FROM SV_LopMonHoc WHERE MaLopMonHoc = 'LMH010'
UNION ALL
SELECT MaSinhVien, MaLopMonHoc, '2023-03-05', NULL FROM SV_LopMonHoc WHERE MaLopMonHoc = 'LMH010'
UNION ALL
SELECT MaSinhVien, MaLopMonHoc, '2023-03-10', NULL FROM SV_LopMonHoc WHERE MaLopMonHoc = 'LMH010';
--SV LMH011
INSERT INTO SV_LopMonHoc (MaLopMonHoc, MaSinhVien, HocKy, NamHoc)
VALUES
('LMH011', 'SV001', '2023A', '2023-2024'),
('LMH011', 'SV002', '2023A', '2023-2024'),
('LMH011', 'SV003', '2023A', '2023-2024'),
('LMH011', 'SV004', '2023A', '2023-2024'),
('LMH011', 'SV005', '2023A', '2023-2024');
--DD LMH011
INSERT INTO DiemDanh (MaSinhVien, MaLopMonHoc, NgayHoc, TrangThai)
SELECT MaSinhVien, MaLopMonHoc, '2023-02-15', NULL FROM SV_LopMonHoc WHERE MaLopMonHoc = 'LMH011'
UNION ALL
SELECT MaSinhVien, MaLopMonHoc, '2023-02-20', NULL FROM SV_LopMonHoc WHERE MaLopMonHoc = 'LMH011'
UNION ALL
SELECT MaSinhVien, MaLopMonHoc, '2023-02-25', NULL FROM SV_LopMonHoc WHERE MaLopMonHoc = 'LMH011'
UNION ALL
SELECT MaSinhVien, MaLopMonHoc, '2023-03-01', NULL FROM SV_LopMonHoc WHERE MaLopMonHoc = 'LMH011'
UNION ALL
SELECT MaSinhVien, MaLopMonHoc, '2023-03-05', NULL FROM SV_LopMonHoc WHERE MaLopMonHoc = 'LMH011'
UNION ALL
SELECT MaSinhVien, MaLopMonHoc, '2023-03-10', NULL FROM SV_LopMonHoc WHERE MaLopMonHoc = 'LMH011';
INSERT INTO SV_LopMonHoc (MaLopMonHoc, MaSinhVien, HocKy, NamHoc)
VALUES
...
INSERT INTO SV_LopMonHoc (MaLopMonHoc, MaSinhVien, HocKy, NamHoc)
VALUES
('LMH007', 'SV001', '2023A', '2023-2024'),
('LMH007', 'SV002', '2023A', '2023-2024'),
('LMH007', 'SV003', '2023A', '2023-2024'),
('LMH007', 'SV004', '2023A', '2023-2024'),
('LMH007', 'SV005', '2023A', '2023-2024');
-- For LMH007
INSERT INTO DiemDanh (MaSinhVien, MaLopMonHoc, NgayHoc, TrangThai)
SELECT MaSinhVien, MaLopMonHoc, '2023-02-15', NULL FROM SV_LopMonHoc WHERE MaLopMonHoc = 'LMH007'
UNION ALL
SELECT MaSinhVien, MaLopMonHoc, '2023-02-20', NULL FROM SV_LopMonHoc WHERE MaLopMonHoc = 'LMH007'
UNION ALL
SELECT MaSinhVien, MaLopMonHoc, '2023-02-25', NULL FROM SV_LopMonHoc WHERE MaLopMonHoc = 'LMH007'
UNION ALL
SELECT MaSinhVien, MaLopMonHoc, '2023-03-01', NULL FROM SV_LopMonHoc WHERE MaLopMonHoc = 'LMH007'
UNION ALL
SELECT MaSinhVien, MaLopMonHoc, '2023-03-05', NULL FROM SV_LopMonHoc WHERE MaLopMonHoc = 'LMH007'
UNION ALL
SELECT MaSinhVien, MaLopMonHoc, '2023-03-10', NULL FROM SV_LopMonHoc WHERE MaLopMonHoc = 'LMH007';
ALTER TABLE SinhVien
