...
namespace DoAn
{
    public partial class DoiMatKhauGiangVien : Form
    {
        ...
        //string BuildSqlQuery(string Id)
        //{
        //    if (checkGV)
        //    {
        //        sql = "select count(*)from GiangVien where MaGiangVien = '"+Id+"' and Password = '"+txt_matkhaucu.Text+"'";
        //    }
        //    else
        //    {
        ...
        private void btn_doimk_Click(object sender, EventArgs e)
        {
            ...
            if(dt.Rows[0][0].ToString()=="1")
            {
                ...
                {
                    SqlDataAdapter da = new SqlDataAdapter("update GiangVien set Password = '" + txt_matkhaumoi.Text + "' where MaGiangVien = '" + Id + "'", db.Connect);
                    int kq = da.Fill(dt);
